...
class Page {
  ...
  public function writePath() {
    return PATH_DIST . ($this->uris ? implode(DIRECTORY_SEPARATOR, $this->uris) . DIRECTORY_SEPARATOR : ''). trim(Page::DIR_NAME, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . $this->fileName() . '.html';
  }
}
