...
$main = main(
  div(
    article(
      ...
      time($article->updateAt->format('Y-m-d 00:00:00'))->editdate('editdate')->date($article->updateAt->format('Y.m.d'))->datetime($article->updateAt->format('Y-m-d 00:00:00')))->class('panel')))->id('main');
