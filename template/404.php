...
<html lang="zh-Hant">
  <head>
    ...
    <script type="text/javascript">$(function() { var $q = $('#q'), timer = null; $q.focus(function() { clearTimeout(timer); }); timer = setTimeout(function() { window.location.replace("<?php echo BASE_URL;?>"); }, 7.5 * 1000); });</script>
  </head>
  <body>
